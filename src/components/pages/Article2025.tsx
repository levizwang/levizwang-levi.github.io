    ...
    <div className="relative z-30 max-w-4xl pb-1 mx-auto mt-10 bg-white dark:bg-background md:rounded-t-md text-neutral-900">
      <div className="relative flex flex-col px-5 pt-6 border-t border-b-0 md:border-r md:border-l md:pt-20 lg:px-0 justify-stretch md:rounded-t-2xl border-neutral-200 dark:border-neutral-800">
        ...
        <div className="w-full max-w-2xl mx-auto mb-6 font-semibold text-neutral-500 dark:text-neutral-300">
          2025年12月25日 · <span className="hover:underline decoration-dashed underline-offset-4">日记本</span> · <span className="hover:underline decoration-dashed underline-offset-4">#年终总结</span>
        </div>
        ...
        <section className="relative w-full max-w-2xl mx-auto">
          <article className="w-full max-w-2xl mx-auto prose-sm prose px-7 lg:px-0 lg:prose-lg dark:prose-invert prose-h3:font-bold prose-h4:font-bold prose-code:font-medium prose-a:underline prose-a:decoration-dashed prose-a:decoration-neutral-300 prose-a:underline-offset-4 prose-a:text-inherit prose-a:font-normal">
            <h2 id="ai-revolution">AI 生产力革命与迷茫</h2>
            ...
            <h2 id="opensource">不合时宜的开源思维</h2>
            <p>相比金钱观的快速转变，我在技术和产品上的观念转得没那么顺利。今年最主要的工作是 Folo。Folo 本身做了很多，新移动端、本地优先架构、AI 等等。但商业化的实施和验证推进太慢，再加上一些现实因素，后来不得不做出一些仓促转型。很多技术上的投入看起来像自娱自乐。</p>
            ...
            <ul>
                ...
                <li>网易云音乐：按理说在国外应该用 Spotify，但 Spotify 的推荐实在不对我胃口。</li>
                <li>Telegram / Discord / Slack / WhatsApp / 微信：即时通讯，越来越分散了。</li>
                <li>OneKey：冷钱包，体验断崖领先。</li>
                <li>Eagle：图片管理。</li>
            </ul>

            <h3 id="gadgets">电子产品</h3>
            <p>年度电子产品是 OneKey Pro。</p>
            <ul>
                <li>雷鸟 V3 让我有点失望。我一直对 Meta 的 AI 眼镜很感兴趣，以为过了这么久，国产竞品会更成熟，结果挺拉的。</li>
            </ul>
          </article>
        </section>
      </div>
